...
import 'package:new_yellow/screens/concert_dashboard/concert_page/third_party_link_web.dart';
...
class ConcertInformationThirdParTicScreen extends StatefulWidget {
  ConcertInformationThirdParTicScreen({ this.img, this.title, this.date, this.city, this.caption, this.price, this.genre, this.docId, this.instagram, this.spotify, this.link_to_buy_ticket, this.postalCode, this.state, this.street});
  final img;
  final title;
  final date;
  ...
  @override
  State<ConcertInformationThirdParTicScreen> createState() => _ConcertInformationThirdParTicScreenState();
}

class _ConcertInformationThirdParTicScreenState extends State<ConcertInformationThirdParTicScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //         child: CustomText(text: "Note: Pressing “Buy Tickets” will take you to an external link where you will be able to purchase tickets for this event.",size: 10,bold: FontWeight.w400,color: Colors.black.withOpacity(0.5),),
                //       )),
                //       SizedBox(height: 20,),
                //       Center(child: Padding(
                //         padding: const EdgeInsets.symmetric(horizontal: 15),
                //         child: CustomText(text: "Tickets to this show are not sold by Yllow. ",size: 10,bold: FontWeight.w400,color: Colors.black.withOpacity(0.5),),
                //       )),
                //       SizedBox(height: 20,),
                //       InkWell(
                //         onTap: () async
                ...
                //          // await makePayment();
                //           log(widget.docId);
                //           Get.to(()=>ThirdPartyWebView());
                //           // await Share.share(
                //           //   widget.link_to_buy_ticket,
                //           //   subject: widget.link_to_buy_ticket,
                //           //   //sharePositionOrigin: box!.localToGlobal(Offset.zero) & box.size,
                //           // );
                //         //  eventCont.eventSold(id: docId);
                ...
                //           ),
                //           child: CustomText(text: "Buy Ticket",size: 13,color: Colors.white,),
                //         ),
                //       ),
                //       SizedBox(height: 20,),
                //
