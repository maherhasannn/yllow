...
class MyTicketFreePage extends StatelessWidget {
  MyTicketFreePage({ this.img, this.title, this.date, this.location, this.caption, this.price, this.genre, this.docId, this.who_play});
  final img;
  final title;
  final who_play;
  final date;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              //         Row(
              //           children: [
              //             Image.asset(height: 20,width:20,"images/e2.png",fit: BoxFit.fill,),
              //             SizedBox(width: 10,),
              //             Center(child: CustomText(text: "21 people are planning to be at your show",size: 12,bold: FontWeight.w700,color: Colors.black,)),
              //           ],
              //         ),
              //         SizedBox(height: 20,),
              //         Row(
              //           children: [
              //             Image.asset(height: 20,width:20,"images/e1.png",fit: BoxFit.fill,),
              //             SizedBox(width: 10,),
              //             Center(child: CustomText(text: "8 people are still thinking about it",size: 12,bold: FontWeight.w700,color: Colors.black,)),
              //           ],
              //         ),
              //         SizedBox(height: 30,),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset(height: 20,width:20,"images/e1.png",fit: BoxFit.fill,),
                        SizedBox(width: 10,),
                        Center(child: CustomText(text: "8 people are still thinking about it",
                          size: 12,bold: FontWeight.w700,color: Colors.black,)),
                      ],
                    ),
                    SizedBox(height: 30,),
                    Center(child: CustomText(text: "Cancel Event",size: 12,bold: FontWeight.w700,
                      color: Colors.black,underLine: TextDecoration.underline,)),
                    SizedBox(height: 30,),
